...
<body>
	...
	<c:set var="i" value="0"></c:set>		
		<form id="f1" method="post" action="GetSolutionServlet">
			...
			<div style="float:left;margin-left:30px">			
				<div>
					<c:if test="${complete != 1 }">
						<input type="button" class="button1" value="提交答案" onclick="checkAnswer()"><br><br>
					</c:if>
					...
					<c:if test="${complete != 1 }">
						<input type="button" class="button1" onclick="getSolution()" value="直接获取答案"><br><br>				
					</c:if>
